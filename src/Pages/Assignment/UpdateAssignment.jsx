                    ...
                    <form onSubmit={handleUpdateAssignment}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="form-control">
                                ...
                                <input type="text" name='imageUrl' defaultValue={imageUrl} placeholder="Enter Image URL" className="input input-bordered border-2 border-emerald-300 focus:outline-none focus:border-emerald-500 rounded-md py-2 px-4  appearance-none leading-normal" required />
                            </div>
                            <div className="form-control">
                                <label className="label">
